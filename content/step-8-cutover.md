...
- Scope `bedrock:InvokeModel` to the specific model ARN where possible.
...
- Define CloudWatch alarms for model errors, API failures, DynamoDB throttling, and search failures.
